...
df.to_csv(r'/home/programming/ip_daily.csv',mode='a',header=False)
...
df.to_csv(r'/home/programming/referer_daily.csv',mode='a',header=False)
...
df.to_csv(r'/home/programming/request_daily.csv',mode='a',header=False)
...
df.to_csv(r'/home/programming/rate_daily.csv',mode='a',header=False)
...
df.to_csv(r'/home/programming/time_daily.csv',mode='a',header=False)
